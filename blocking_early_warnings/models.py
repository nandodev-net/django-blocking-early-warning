...
# Local imports
from blocking_early_warnings.settings import NUMBER_OF_DAYS
...
class Url(models.Model):
    ...
    url = models.TextField(max_length=100, null=False)
    ...
    @staticmethod
    def post_save(sender, instance, created, raw, using, update_fields, *args, **kwargs):
        """
